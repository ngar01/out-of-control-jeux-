...
//--------------------------------------------------------------------------------------------------------------------------------
void validation(int choix, int *valid, int i, int ligne, int reponse[], SDL_Rect positionEnigme, SDL_Surface *ecran,SDL_Surface* youWin, SDL_Surface* gameOver, Mix_Chunk* win, Mix_Chunk* lose)
{
...
//------------------------------------------------------------------------------------------------------------------------------
void liberation(SDL_Surface *imageDeFond,SDL_Surface *enigme,SDL_Surface *question,SDL_Surface *r1,SDL_Surface *r2,SDL_Surface *r3,SDL_Surface *r4,SDL_Surface *youWin,SDL_Surface *gameOver,Mix_Music* backgroundSound,Mix_Chunk* button,Mix_Chunk *win,Mix_Chunk *lose, TTF_Font *police)
{
...
void init(enigmes *E)
{
E->imageDeFond= IMG_Load ("fond.jpg");
E->i=1;
E->choix=0;
E->ligne=1;
E->son=0;
